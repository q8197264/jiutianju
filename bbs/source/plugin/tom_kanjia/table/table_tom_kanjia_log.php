...
class table_tom_kanjia_log extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_kanjia_log';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_openid($kid,$uid,$openid) {
		return DB::fetch_first("SELECT * FROM %t WHERE kj_id=%d AND user_id=%d AND openid=%s ",array($this->_table,$kid,$uid,$openid));
	}
