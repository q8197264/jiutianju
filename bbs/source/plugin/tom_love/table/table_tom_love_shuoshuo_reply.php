...
class table_tom_love_shuoshuo_reply extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_love_shuoshuo_reply';
		$this->_pk    = 'id';
	}
    ...
    public function delete_by_ssid($ssid) {
		return DB::query("DELETE FROM %t WHERE ss_id=%d", array($this->_table, $ssid));
	}
