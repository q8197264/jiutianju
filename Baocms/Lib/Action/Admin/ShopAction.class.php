...
class ShopAction extends CommonAction{
    private $create_fields = array('user_id', 'cate_id','grade_id', 'city_id', 'area_id', 'business_id', 'shop_name', 'logo', 'mobile', 'photo', 'addr', 'tel', 'extension', 'contact', 'tags', 'near', 'is_pei', 'business_time', 'delivery_time', 'orderby', 'lng', 'lat', 'price','shipping_fee', 'recognition', 'panorama_url');
    private $edit_fields = array('user_id', 'cate_id','grade_id', 'city_id', 'area_id', 'business_id', 'shop_name', 'mobile', 'logo', 'photo', 'addr', 'tel', 'extension', 'contact', 'tags', 'near', 'business_time', 'delivery_time', 'is_pei', 'orderby', 'lng', 'lat', 'price','shipping_fee', 'is_ding', 'recognition', 'apiKey', 'mKey', 'partner', 'machine_code','service','service_audit','is_ele_print','is_tuan_print','is_goods_print','is_ding_print','service_audit', 'panorama_url');
    ...
    private function createCheck()
    {
        ...
        $data['shipping_fee'] = (int) $data['shipping_fee']*100;
    ...
    public function edit($shop_id = 0)
    {
        if ($shop_id = (int) $shop_id) {
            ...
            if ($this->isPost()) {
                ...
                $detail['shipping_fee'] = (int) $detail['shipping_fee']/100;
                $this->assign('areas', D('Area')->fetchAll());
                $this->assign('cates', D('Shopcate')->fetchAll());
                $this->assign('business', D('Business')->fetchAll());
