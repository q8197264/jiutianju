...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title','intro','shoplx','guige', 'num','is_reight','weight','kuaidi_id','shop_id', 'photo', 'cate_id', 'price', 'mall_price','use_integral','mobile_fan', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','is_vs1','is_vs2','is_vs3','is_vs4','is_vs5','is_vs6','is_backers','is_fanli');
    private $edit_fields = array('title','intro','shoplx','guige','num', 'is_reight','weight','kuaidi_id','shop_id', 'photo', 'cate_id', 'price', 'mall_price','use_integral','mobile_fan', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','is_vs1','is_vs2','is_vs3','is_vs4','is_vs5','is_vs6','is_backers','is_fanli');
...
*/
    ...
    private function editCheck() {
        ...
        $data['orderby'] = (int) $data['orderby'];
		$data['is_backers'] = (int) $data['is_backers'];
		$data['is_fanli'] = (int) $data['is_fanli'];
        return $data;
    }
