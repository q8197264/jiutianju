...
class UserrankAction extends CommonAction{
    private $create_fields = array('rank_name', 'number', 'discount', 'reward', 'icon', 'icon1','integral', 'prestige', 'rebate', 'photo', 'money', 'orderby');
    private $edit_fields = array('rank_name', 'number', 'discount', 'reward', 'icon', 'icon1','integral', 'prestige', 'rebate', 'photo', 'money', 'orderby');
