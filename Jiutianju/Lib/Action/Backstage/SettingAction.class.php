...
class SettingAction extends CommonAction{
    ...
    public function mall(){
	 ...
	 public function village(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('设置成功', U('setting/village'));
        } else {
            $this->display();
        }
    }
	public function rank(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'rank', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('会员设置成功', U('setting/rank'));
        } else {
            $this->display();
        }
    }
	 public function tuan(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'tuan', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('抢购相关设置成功', U('setting/tuan'));
        } else {
            $this->display();
        }
    }
	 public function edu(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'edu', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('教育课程相关设置成功', U('setting/edu'));
        } else {
            $this->display();
        }
    }
	 public function yx(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'yx', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('营销活动相关设置成功', U('setting/yx'));
        } else {
            $this->display();
        }
    }
	 public function coupon(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'coupon', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('优惠券相关设置成功', U('setting/coupon'));
        } else {
            $this->display();
        }
    }
	 public function tuanprice(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'tuanprice', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('费率设置成功', U('setting/tuanprice'));
        } else {
            $this->display();
        }
    }
	 public function hotel(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'hotel', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('费率设置成功', U('setting/hotel'));
        } else {
            $this->display();
        }
    }
	 public function farm(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'farm', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('费率设置成功', U('setting/farm'));
        } else {
            $this->display();
        }
    }
	 public function cloud(){
        if ($this->isPost()) {
            $data = $this->_post('data', false);
            $data = serialize($data);
            D('Setting')->save(array('k' => 'cloud', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('费率设置成功', U('setting/cloud'));
        } else {
            $this->display();
        }
    }
   ...
   public function sms(){
	...
	public function shop(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('商户设置成功', U('setting/shop'));
        } else {
            $this->display();
        }
    }
	...
	public function ktv(){
        if ($this->isPost()) {
            ...
            $data['time'] = time();
            $data = serialize($data);
            D('Setting')->save(array('k' => 'ktv', 'v' => $data));
            D('Setting')->cleanCache();
            $this->baoSuccess('KTV设置成功', U('setting/ktv'));
        } else {
            $this->display();
        }
    }
	public function life(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('分类价格设置成功', U('setting/life'));
        } else {
            $this->display();
        }
    }
