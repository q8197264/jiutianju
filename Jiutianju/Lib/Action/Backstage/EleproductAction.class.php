...
class EleproductAction extends CommonAction{
    private $create_fields = array('product_name', 'shop_id', 'cate_id', 'photo', 'price','is_new', 'is_hot', 'is_tuijian', 'sold_num', 'month_num', 'create_time', 'create_ip','cost_price');
    private $edit_fields = array('product_name', 'shop_id', 'cate_id', 'photo', 'price', 'settlement_price','is_new', 'is_hot', 'is_tuijian', 'sold_num', 'month_num','cost_price');
