...
class EleAction extends CommonAction{
    private $create_fields = array('shop_id', 'distribution', 'is_open', 'is_pay', 'is_fan', 'fan_money', 'is_new', 'full_money', 'new_money', 'logistics', 'since_money', 'sold_num', 'month_num', 'intro', 'orderby','cj_money');
    protected $ele;
    ...
    public function open(){
        ...
        $cj_money = (int) ($_POST['cj_money']*100);
