...
class PintuanAction extends CommonAction {
	...
	public function addlist() {
		...
		if ($tuan_id == 0) {
			$buyUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/buy/tstatus/" . $tstatus . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
			$editUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/addedit/tstatus/" . $tstatus . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
			$delUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/adddels/tstatus/" . $tstatus . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
		} else {
			$buyUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/buy/tstatus/" . $tstatus . "/tuan_id/" . $tuan_id . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
			$editUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/addedit/tstatus/" . $tstatus . "/tuan_id/" . $tuan_id . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
			$delUrl = "http://" . $_SERVER['HTTP_HOST'] . "/mobile/pintuan/adddels/tstatus/" . $tstatus . "/tuan_id/" . $tuan_id . "/tlevel/" . $tlevel . "/id/" . $goods_id . "/order_id/" . $order_id . "/address_id/";
		}
