...
$configs   = array(
    //'配置项'=>'配置值'
    'APP_GROUP_LIST'        => 'Backstage,Merchant,Wap,Delivery,Distributors,App,Wuye,User,Members,Home,Being,Grab,Substation,Weixin,Worker,Property,Village,Agent,Proxy', //项目分组设定
